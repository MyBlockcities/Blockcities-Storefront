  ...
  return (
    <>
      <Banner
        ...
        subHeadingText={'The Blockcities™ platform is powering a sustainable future using blockchain technology. Supported asset classes include real estate, managed agriculture and renewable energy. Buy exclusive Metaplex NFTs.'}
